...
tryInjectRosettaScript('https://d3cy3u1txmkqs3.cloudfront.net/rosetta/translations2022/new-frontend/files/new-frontend.en.1185724034.js', 'https://ecwid-rosetta.s3.amazonaws.com/translations2022/new-frontend/files/new-frontend.en.1185724034.js');
})();
(function() {
...
script.src = selectJsVersion('https://d3cy3u1txmkqs3.cloudfront.net/venera/static/ecwid-storefront.03050114b4b0bd08d93c7462b0a886d5.min.js');
document.getElementsByTagName('head')[0].appendChild(script);
}
...
script.src = selectJsVersion('https://d3cy3u1txmkqs3.cloudfront.net/venera/static/ecwid-checkout.d4e486a0497083b1b35987e4254a1f10.min.js');
document.getElementsByTagName('head')[0].appendChild(script);
...
EcwidObj.storefrontVersion = "2023-46324-gf11459e5017389";
...
EcwidObj.signature = "d8e39a16c982aa71d705e4da44ae2d17-0";
...
window.ec_legacyCssUrl = 'https://d1oxsl77a1kjht.cloudfront.net/css/new?hc=-1802687677&ownerid=19645090&withoutLegacyCss=true' + cssUrlAddition;
var cssUrl = 'https://d1oxsl77a1kjht.cloudfront.net/css/new?hc=-1802687677&ownerid=19645090&withoutLegacyCss=true' + cssUrlAddition;
...
return EcwidObj._filter(appsData, function(appData) {
return EcwidObj._isAppEnabled(appData.namespace)
});
}
...
EcwidObj._forEach(enabledAppsWithCssUrl, function(appData) {
...
EcwidObj._forEach(enabledAppsWithJsUrl, function(appData) {
attachAppScript(appData.jsUrl, appData.asyncJs);
});
EcwidLogger.log('Installed apps ' + EcwidObj._map(appsWithJsUrl, function(appData) { return appData.namespace; } ));
EcwidLogger.log('Enabled apps ' + EcwidObj._map(enabledAppsWithJsUrl, function(appData) { return appData.namespace; } ));
}
if (!EcwidObj.appsStylesheetsAttached) {
attachAllAppsStylesheets();
EcwidObj.appsStylesheetsAttached = true;
}
if (!EcwidObj.appsScriptsAttached) {
attachAllAppsScripts();
EcwidObj.appsScriptsAttached = true;
}
}, 0);
};
...
xInjectJs('https://d3dq8sxcny4hg.cloudfront.net/states.js?version=2023-46324-gf11459e5017389&callback=window.ecwid_states_data.loaded');
...
window.ecwid_script_base="https://d11s7fcxy18ubx.cloudfront.net/node/static/2023/2023-46324-gf11459e5017389/ru.cdev.xnext.frontend.LegacyFrontend/";
window.ecwid_static_base="https://d11s7fcxy18ubx.cloudfront.net/node/static/2023/2023-46324-gf11459e5017389/"
...
window.xnext_ownerId=19645090;
EcwidObj.publicToken = "public_fYQSrDymWVr7HVufyBxG8BVZupv7pNrn",
EcwidObj.demo=false;
EcwidObj.cssUrl="https://d1oxsl77a1kjht.cloudfront.net/css/new?hc=-1802687677&ownerid=19645090&withoutLegacyCss=true";
EcwidObj.acceptLanguage=["en"];
EcwidObj.appDomain="https://app.ecwid.com/";
...
var ecDataJsBaseUrl = "https://app.ecwid.com/data.js?ownerid=19645090";
ecDataJsBaseUrl += "&lang=en";
ecDataJsBaseUrl += "&token=63f0bb1b8734faa3f9af9bd6d4ddf9ec4e731590";
...
var tokenMap = {"custom-app-19645090-1":"public_Kj7iaWKGSDH9u4NNScAJss7KUyspE1Dg","ecwid-storefront":"public_fYQSrDymWVr7HVufyBxG8BVZupv7pNrn"};
...
EcwidObj.getAppPublicConfig = function(namespace) {
	var publicData = {"ecwid-iphone-app":"{}","ecwid-android-app":"{}","square":"{}","ecwid-edit-orders":"{}","custom-app-19645090-1":"{}","storefront-label-editor":"{}","ecwid-degenerator-app":"{}","ecwid-storefront":"{}"};
